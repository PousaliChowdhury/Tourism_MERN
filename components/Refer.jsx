  ...
  return (
    ...
    <div className='review'>
      <div className='container'>
        ...
        <div className='share'>
          <input type='text' placeholder='Share your Experiences'></input>
          <Link to="/SignUp"><div className='icon'><button className="btn"><i class="fa-solid fa-paper-plane"></i></button></div></Link>
        </div>
    </div>
    </div>
